	...
	var Greeter = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(GreeterForm, { updateInfo: this.handleForm })
	        );
	    }
	});
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                null,
	                React.createElement('input', { type: 'text', ref: 'name', placeholder: 'Type Name...' })
	            ),
	            React.createElement(
	                'div',
	                null,
	                React.createElement('textarea', { ref: 'message', placeholder: 'Type message...' })
	            ),
	            React.createElement(
	                'button',
	                null,
